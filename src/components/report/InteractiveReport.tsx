              ...
              <div className="space-y-4">
                ...
                <motion.div variants={scaleIn} className="bg-primary/5 border border-primary/20 rounded-2xl p-6">
                  ...
                  <ul className="space-y-2 text-sm font-body text-muted-foreground">
                    ...
                    <li className="flex items-start gap-2"><span className="text-primary mt-1">•</span>•
Articulación con Asamblea Departamental, comités departamentales de seguridad alimentaria y nutricional, comités municipales, asamblea departamental, organizaciones sociales, instituciones de orden departamental nacional, cooperación internacional y la comunidad general</li>
